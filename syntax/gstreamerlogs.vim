...
syntax match GstLevelWarning /\<WARN\(ING\)\?\>/  contained  nextgroup=GstCategory  skipwhite
...
syntax match GstLevelLog     /\<\(LOG\|TRACE\)\>/ contained  nextgroup=GstCategory  skipwhite
...
highlight default GstContinuation ctermfg=242  guifg=#777777  cterm=italic gui=italic
